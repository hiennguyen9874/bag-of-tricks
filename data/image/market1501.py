...
class Market1501(object):
    ...
    dataset_id = '1orcKWZv8k9BK2sh8zS4sgt5RR_TsRCIc'
    ...
    def __init__(self, root_dir='datasets', download=True, extract=True, re_label_on_train=True):
        ...
        if not os.path.exists(os.path.join(self.data_dir, 'bounding_box_train')):
            self.data_dir = os.path.join(
                self.data_dir, self.file_name.split('.zip')[0])
